...
extension Lexer_AdvanceTests {
    ...
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__Lexer_AdvanceTests = [
...
extension Lexer_ConsumeTests {
    ...
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__Lexer_ConsumeTests = [
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(Lexer_AdvanceTests.__allTests__Lexer_AdvanceTests),
        testCase(Lexer_ConsumeTests.__allTests__Lexer_ConsumeTests),
